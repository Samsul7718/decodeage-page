...
document.getElementById('shopBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div2');
    bottomDiv2.style.display = 'flex';
});
document.getElementById('crossBtn2').addEventListener('click', function() {
    var bottomDiv2 = document.querySelector('.bottom-div2');
    bottomDiv2.style.display = "none";
});
document.getElementById('shopBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div2');
...
document.getElementById('categoryBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div6');
    bottomDiv2.style.display = 'flex';
});
document.getElementById('crossBtn6').addEventListener('click', function() {
    var bottomDiv2 = document.querySelector('.bottom-div6');
    bottomDiv2.style.display = "none";
});
document.getElementById('hcBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div3');
    bottomDiv2.style.display = 'flex';
});
document.getElementById('crossBtn3').addEventListener('click', function() {
    var bottomDiv2 = document.querySelector('.bottom-div3');
    bottomDiv2.style.display = "none";
});
document.getElementById('articleBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div4');
    bottomDiv2.style.display = 'flex';
});
document.getElementById('crossBtn4').addEventListener('click', function() {
    var bottomDiv2 = document.querySelector('.bottom-div4');
    bottomDiv2.style.display = "none";
});
document.getElementById('aboutBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div5');
    bottomDiv2.style.display = 'flex';
});
document.getElementById('crossBtn5').addEventListener('click', function() {
    var bottomDiv2 = document.querySelector('.bottom-div5');
    bottomDiv2.style.display = "none";
});
...
document.getElementById('sBtn').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div7');
    bottomDiv2.style.display = 'flex';
});
document.getElementById('crossBtn7').addEventListener('click', function() {
    var bottomDiv2 = document.querySelector('.bottom-div7');
    bottomDiv2.style.display = "none";
});
document.getElementById('sBtn2').addEventListener('click', function(e) {
    e.preventDefault();
    var bottomDiv2 = document.querySelector('.bottom-div7');
    bottomDiv2.style.display = 'flex';
});
...
const dropDown = document.getElementById(select-list-data);
