...
secondDropdownButton.addEventListener('click', function() {
  secondDropdownOptions.classList.toggle('show');
  secondArrowBtn.classList.toggle('open');
});
...
document.addEventListener('click', function(e) {
  ...
  if (!secondDropdownButton.contains(e.target)) {
    secondDropdownOptions.classList.remove('show');
    secondArrowBtn.classList.remove('open');
  }
});
})
// popup container
