...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      dropdownButton.addEventListener('click', function () {
        ...
        dropdownButton.querySelector('.arrow').classList.toggle('rotate');
      });
      ...
      dropdownOptions.querySelectorAll('.option').forEach(function (option) {
        option.addEventListener('click', function () {
          ...
          dropdownButton.innerHTML = `<img src="${imgSrc}" alt="${text}"> ${text} <span class="arrow">&#9660;</span>`;
          dropdownOptions.classList.remove('show');
          dropdownButton.querySelector('.arrow').classList.remove('rotate');
        });
      });
